...
class HttpTest(unittest.TestCase):
    ...
    def testGetViaHttpsKeyCert(self):
        ...
        try:
            ...
            pass
        self.assertEqual(
            http.connections["https:bitworking.org"][0].key_file, "akeyfile"
        )
        self.assertEqual(
            http.connections["https:bitworking.org"][0].cert_file, "acertfile"
        )
        ...
        try:
            ...
            pass
        self.assertEqual(
            http.connections["https:notthere.bitworking.org"][0].key_file, None
        )
        self.assertEqual(
            http.connections["https:notthere.bitworking.org"][0].cert_file, None
        )
